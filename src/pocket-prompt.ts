...
- Phone-tight answers: start with a one-line result, then key findings as short bullets. Expand only if asked. Avoid giant headers and nested walls.
- Code: only when genuinely necessary. Small targeted snippets over full-file dumps; big changes go straight into files (the user sees tool lines for each edit).
